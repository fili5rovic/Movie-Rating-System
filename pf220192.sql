USE master;
GO
-- ALTER DATABASE [SAB_PROJECT] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
DROP DATABASE [SAB_PROJECT];
GO
CREATE DATABASE SAB_PROJECT; 
GO
...
CREATE PROCEDURE SP_RECOMMENDATION
    @id INT
AS
BEGIN
    SET NOCOUNT ON;
...
CREATE PROCEDURE SP_REWARD_USER_PROC
    @idKor INT
AS
BEGIN
    SET NOCOUNT ON;
